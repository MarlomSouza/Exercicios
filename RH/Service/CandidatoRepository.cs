...
namespace RH.Service
{
    public class CandidatoRepository : ICandidatoRepository
    {
        ...
        {
            return _dbContext.Candidatos.Include(c => c.Tecnologias).ThenInclude(t => t.Tecnologia).Include(c => c.Triagens).ThenInclude(t => t.Triagem).FirstAsync(c => c.Id.Equals(id));
        }

        public IEnumerable<Candidato> List()
        {
            return _dbContext.Candidatos.Include(c => c.Tecnologias).ThenInclude(t => t.Tecnologia).Include(c => c.Triagens).ThenInclude(t => t.Triagem).AsEnumerable();
        }
